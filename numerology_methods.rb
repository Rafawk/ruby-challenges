...
def birthday_number(birthday)
    
    numSum = birthday[0].to_i + birthday[1].to_i + birthday[2].to_i+ birthday[3].to_i+birthday[4].to_i+birthday[5].to_i+birthday[6].to_i+birthday[7].to_i
    
    numSum.to_s
    
    birthdaySum = numSum[0].to_i + numSum[1].to_i
    
    if (birthdaySum > 9)
        birthdaySum.to_s
        birthdaySum = birthdaySum[0].to_i +  birthdaySum[1].to_i
    end
    return birthdaySum
end

def birthday_message(birthdaySum)
    case birthdaySum
    when 1
...
bdayNum = birthday_number(birthday)

message = birthday_message(bdayNum)
